		...
		<div class="shell">
			...
			<div class="main">
				...
				<section class="post">
					...
					<div class="post-cnt">
						<h2>Wowza 3.x & Icecast2 live statistics</h2>
						<p>
				...
				<section class="content">
					<h2>WHO I AM</h2>
					<p>My Nickname is Maca and my real name is Jeroen van Marion and i fill my daytime with a job as a software consultant. In my spare time i like to play around with all kind of things related to ICT/IT. I have an allround knowledge of Windows Servers, Linux Servers as well as hardware as software related, Gameserver configuration, MySQL, SQL, HTML, XHTML, CSS, CSS3 and a bit of php coding experience.<br /><br /> I love opensource software and am willing to take part of opensource projects where ever i can. I also like to solve problems or build things that are normally a paid service. My php knowledge can always be improved, but it gets me where i want to go:D. </p>
				</section>
<!--
