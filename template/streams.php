...
<head>
	...
	<title>Maca - Demo Site realtime Charts Wowza 4.0.x </title>
				...
				<div class="header-top">
					...
					<nav id="navigation">
						...
						<ul>
							...
							<li class="active home"><a href="streams.php">Streams</a></li>
			...
			<div class="main">
				...
				<section class="cols">
					...
					<div class="col">
						...
						<div class="col-cnt">
							<h2>Logging</h2>
							<p>No logging, only use of live logs </p>
				...
				<section class="content">
					<h2>Demo All Wowza streams</h2>
							<?php include ('../get-server-charts.php'); ?>
